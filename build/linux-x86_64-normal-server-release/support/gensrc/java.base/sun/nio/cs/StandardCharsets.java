...
public class StandardCharsets extends CharsetProvider {
    ...
    static final String[] aliases_Big5 = new String[] {
        "csBig5",
    };

    static final String[] aliases_EUC_TW = new String[] {
        "euc_tw",
        "euctw",
        "cns11643",
        "EUC-TW",
    ...
    static final String[] aliases_Big5_HKSCS = new String[] {
        "Big5_HKSCS",
        "big5hk",
        "big5-hkscs",
        "big5hkscs",
    ...
    static final String[] aliases_Big5_Solaris = new String[] {
        "Big5_Solaris",
    };

    static final String[] aliases_GBK = new String[] {
        "windows-936",
        "CP936",
    };

    static final String[] aliases_GB18030 = new String[] {
        "gb18030-2000",
    };

    static final String[] aliases_EUC_CN = new String[] {
        "gb2312",
        "gb2312-80",
        "gb2312-1980",
        "euc-cn",
    ...
    static final String[] aliases_JIS_X_0201 = new String[] {
        "JIS0201",
        "JIS_X0201",
        "X0201",
        "csHalfWidthKatakana",
    ...
    static final String[] aliases_JIS_X_0208 = new String[] {
        "JIS0208",
        "JIS_C6226-1983",
        "iso-ir-87",
        "x0208",
    ...
    static final String[] aliases_JIS_X_0212 = new String[] {
        "JIS0212",
        "jis_x0212-1990",
        "x0212",
        "iso-ir-159",
    ...
    static final String[] aliases_EUC_JP = new String[] {
        "euc_jp",
        "eucjis",
        "eucjp",
    ...
    static final String[] aliases_EUC_JP_LINUX = new String[] {
        "euc_jp_linux",
        "euc-jp-linux",
    };

    static final String[] aliases_EUC_JP_Open = new String[] {
        "EUC_JP_Solaris",
        "eucJP-open",
    };

    static final String[] aliases_PCK = new String[] {
        "pck",
    };

    static final String[] aliases_EUC_KR = new String[] {
        "euc_kr",
        "ksc5601",
        "euckr",
        "ks_c_5601-1987",
    ...
    static final String[] aliases_Johab = new String[] {
        "ksc5601-1992",
        "ksc5601_1992",
        "ms1361",
        "johab",
    ...
    static final String[] aliases_ISO_8859_3 = new String[] {
        "iso8859_3",
        "8859_3",
        "ISO_8859-3:1988",
        "iso-ir-109",
    ...
    static final String[] aliases_ISO_8859_6 = new String[] {
        "iso8859_6",
        "8859_6",
        "iso-ir-127",
        "ISO_8859-6",
    ...
    static final String[] aliases_ISO_8859_8 = new String[] {
        "iso8859_8",
        "8859_8",
        "iso-ir-138",
        "ISO_8859-8",
    ...
    static final String[] aliases_ISO_8859_11 = new String[] {
        "iso-8859-11",
        "iso8859_11",
    };

    static final String[] aliases_TIS_620 = new String[] {
        "tis620",
        "tis620.2533",
    };

    static final String[] aliases_JIS_X_0208_Solaris = null;

    static final String[] aliases_JIS_X_0212_Solaris = null;
        ...
        extends sun.util.PreHashedMap<String>
    {
        ...
        private static final int SIZE = 314;
