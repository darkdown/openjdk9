...
public final class compiler extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compiler.err.duplicate.exports", "duplicate export: {0}" },
            ...
            { "compiler.err.module-info.with.xmodule.classpath", "illegal combination of -Xmodule and module-info on classpath" },
            { "compiler.err.module-info.with.xmodule.sourcepath", "illegal combination of -Xmodule and module-info on sourcepath" },
            ...
            { "compiler.err.not.def.access.package.cant.access", "{0} is not visible because package {1} is not visible" },
            ...
            { "compiler.err.service.implementation.must.be.subtype.of.service.interface", "the service implementation type must be a subtype of the service interface type" },
            ...
            { "compiler.err.xmodule.no.module.sourcepath", "illegal combination of -Xmodule and --module-source-path" },
            ...
            { "compiler.warn.leaks.not.accessible.not.required.public", "{0} {1} in module {2} is not indirectly exported using 'requires public'" },
