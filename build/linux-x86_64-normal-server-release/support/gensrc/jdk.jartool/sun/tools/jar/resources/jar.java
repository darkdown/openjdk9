...
public final class jar extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "error.versioned.info.exports.notequal", "module-info.class in a versioned directory contains different \"exports\"" },
            { "error.versioned.info.name.notequal", "module-info.class in a versioned directory contains incorrect name" },
            { "error.versioned.info.provides.notequal", "module-info.class in a versioned directory contains different \"provides\"" },
            { "error.versioned.info.requires.added", "module-info.class in a versioned directory contains additional \"requires\"" },
            { "error.versioned.info.requires.dropped", "module-info.class in a versioned directory contains missing \"requires\"" },
            { "error.versioned.info.requires.public", "module-info.class in a versioned directory contains additional \"requires public\"" },
            { "error.versioned.info.without.root", "module-info.class found in a versioned directory without module-info.class in the root" },
            ...
            { "warn.validator.identical.entry", "warning - entry: {0} contains a class that is identical to an entry already in the jar" },
