...
public final class plugins extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "exclude-files.description", "Specify files to exclude. e.g.: **.java,glob:/java.base/native/client/**" },
            ...
            { "generate-jli-classes.description", "Takes a file hinting to jlink what java.lang.invoke classes to pre-generate. If\nthis flag is not specified a default set of classes will be generated." },
            ...
            { "plugin.opt.c", "  -c, --compress=<0|1|2>            Enable compression of resources\n                                    More details in --list-plugins option" },
            ...
            { "plugin.opt.plugin-module-path", "  --plugin-module-path <modulepath> Custom plugin module path" },
